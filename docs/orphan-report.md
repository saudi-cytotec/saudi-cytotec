...
|---|---|
| `cytotec-definition` | `misoprostol-active-ingredient`, `difference-cytotec-misoprostol`, `history-development-misoprostol`, `misoprostol-other-brand-names`, `key-facts-before-reading-cytotec`, `brand-name-vs-active-ingredient`, `cytotec-uses` |
| `misoprostol-active-ingredient` | `cytotec-definition`, `misoprostol-pharmacologic-class`, `how-misoprostol-works-in-body`, `cytotec-uses` |
...
| `when-symptoms-are-emergencies` | `fever-and-chills`, `rare-serious-complications`, `what-to-do-if-side-effects`, `high-fever-and-infection`, `annoying-symptom-vs-emergency` |
