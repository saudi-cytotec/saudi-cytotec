  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-8">
      ...
      <PageHero
        ...
        description="دليل يوضح كيف تصلين إلى الرعاية والصرف المرخّص داخل المملكة عبر القنوات الرسمية لوزارة الصحة والهيئة العامة للغذاء والدواء، مع معلومات دوائية موثّقة وشروط الصرف بالوصفة الطبية."
      >
