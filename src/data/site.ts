...
export const SITE = {
  ...
  language: "ar",
  description:
    "منصة سعودية للخدمات والمعلومات الدوائية المرتبطة بصحة المرأة: الحمل، الخصوبة، الدورة الشهرية، الصحة الإنجابية، سلامة الأدوية، والطوارئ النسائية. تتضمن دليلاً دوائياً موثّقاً عن سايتوتك وميزوبروستول وشروط الصرف بالوصفة الطبية عبر الصيدليات المرخّصة وفق الأنظمة المعمول بها.",
  email: "info@saudiersaa.com",
  updated: "2026-09-06",
};

export const DISCLAIMER_SHORT =
  "هذا المحتوى للتوعية الدوائية العامة، ولا يُعد استشارة طبية فردية ولا وصفة. تُصرف الأدوية الخاضعة للتنظيم في المملكة بوصفة طبية عبر الصيدليات المرخّصة، والقرار العلاجي يبقى للطبيب المرخّص.";
