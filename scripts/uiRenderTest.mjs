...
const REQUIRED_EDITOR = ["العنوان", "H1", "الرابط (slug)", "الكلمة المفتاحية الأساسية", "عنوان SEO", "الوصف التعريفي", "جسم المقال", "أسئلة متكررة", "المراجع", "الصورة الرئيسية", "نص بديل للصورة", "حفظ مسودة", "نشر", "معاينة", "إخلاء المسؤولية الطبية"];
